...
void maxiginGame_getNativePixels( unsigned char *inRGBBuffer ) {
    ...
    if( testColor ) {
        ...
        for( c = 0;
            ...
            unsigned char  r   =  (unsigned char)maxigin_randRange( &cRand,
                                                                    0, 255 );
            unsigned char  g   =  (unsigned char)maxigin_randRange( &cRand,
                                                                    0, 255 );
            unsigned char  b   =  (unsigned char)maxigin_randRange( &cRand,
                                                                    0, 255 );
            unsigned char  r2;
            unsigned char  g2;
            unsigned char  b2;
            ...
            maxigin_drawSetColor( r, g, b, 255 );

            s = maxigin_drawGetColorSaturation();
            
            s2 = maxigin_randRange( &cRand,
                                    0, 10000 );
            
            maxigin_drawSetColorSaturation( s2 );

            maxigin_drawGetColor( &r2, &g2, &b2, &a2 );

            maxigin_logInt2( "conversion r = ",
                             r,
                             ", g = ",
                             g,
                             "" );
    ...
    for( rTest = 0;
        ...
        for( gTest = 0;
            ...
            for( bTest = 0;
                ...
                unsigned char  r   =  (unsigned char)rTest;
                unsigned char  g   =  (unsigned char)gTest;
                unsigned char  b   =  (unsigned char)bTest;
                unsigned char  r2;
                unsigned char  g2;
                unsigned char  b2;
                unsigned char  a2;
                ...
                maxigin_drawSetColorSaturation( s );
                ...
                if( r2 != r
                    ...
                    maxigin_logInt2( "Bad conversion r = ",
                                     r,
                                     ", g = ",
                                     g,
                                     "" );
                    ...
                    maxigin_logInt2( "  Bad conversion r2 = ",
                                     r2,
                                     ", g2 = ",
                                     g2,
                                     "" );
