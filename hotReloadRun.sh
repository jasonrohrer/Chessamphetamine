...
fileList="$quitFileName Chessamphetamine game.c maxigin.h mingin.h board.h pieceSprites.h chess.h memoryRegister.h particleSprite.h gameSize.h simTest.h moveAnim.h"
